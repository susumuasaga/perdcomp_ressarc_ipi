...
const writeR13_1 = __importDefault(require("../writeR13"));
describe('writeR13', () => {
    let notaFiscalModel;
    beforeAll(async () => {
    ...
    it('can write file', async () => {
        const entidade = { cnpj: '00000000000191', nome: '',
            paAno: 2018, paMes: 4 };
        await writeR13_1.default(notaFiscalModel, entidade);
        const expected = fs_1.default.readFileSync('spec/R13201804.txt', 'utf8');
        const received = fs_1.default.readFileSync('R13201804.txt', 'utf8');
