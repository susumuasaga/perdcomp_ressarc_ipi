...
async function writeR15(notaFiscalModel, entidade) {
    ...
    const out = fs_1.default.createWriteStream(`R15${formatRMais_1.formatAAAA(paAno)}${formatRMais_1.formatMM(paMes)}.txt`);
