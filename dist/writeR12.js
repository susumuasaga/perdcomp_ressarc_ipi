...
async function writeR12(registroIPIModel, entidade) {
    ...
    const out = fs_1.default.createWriteStream(`R12${formatRMais_1.formatAAAA(paAno)}${formatRMais_1.formatMM(paMes)}.txt`);
